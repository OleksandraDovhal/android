  ...
  public CityDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCity = new EntityInsertionAdapter<City>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `city` (`city_id`,`city_name`,`city_area`,`founded`,`latitude`,`longitude`) VALUES (?,?,?,?,?,?)";
      }
  ...
  public List<City> getAll() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new City(_tmpCityId,_tmpCityName,_tmpCityArea,_tmpFounded,_tmpLatitude,_tmpLongitude);
        _result.add(_item);
      }
      return _result;
    } finally {
